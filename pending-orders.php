...
header('location:login.php');
	...
	if (isset($_GET['id'])) {
		...
		mysqli_query($con,"delete from orders  where userId='".$_SESSION['login']."' and paymentMethod is null and id='".$_GET['id']."' ");
		;
