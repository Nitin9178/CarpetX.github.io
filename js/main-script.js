...
$(document).ready(function(){
	...
	$('#c-form').submit(function(e){
		...
		var user_name = contact_form.getElementById("user_name").val();
		var mail = contact_form.getElementById("user_mail").val();
		var msg = contact_form.getElementById("message").val();
		var error = false;
