                    ...
                    <div class="product">
                        <div class="product-image">
                            <div class="image">
                                ...
                                <img src="assets/images/blank.gif" data-echo="admin/productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage1']);?>"
                                 ...
                                 <li class="add-cart-button btn-group">
                                     <?php
                                      if($row['productAvailability']=='In Stock')
										{
										  ?>
                                        <form role="form" class="sub-cart-submit">
                                          <input type="hidden" class="product_id" value="<?= $row["id"] ?>">
                                         <button class="btn btn-primary btn-block addCartItem">
                                            <i class="fa fa-shopping-cart"></i>&nbsp;Add to cart</button>
                                            <button class="btn btn-primary btn-block addWishItem">
