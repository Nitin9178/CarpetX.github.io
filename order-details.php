...
<head>
    ...
    function popUpWindow(URLStr, left, top, width, height) 
    {
        ...
        popUpWin = open(URLStr, 'popUpWin',
            ...
            600 + ',height=' + 300 + ',left=' + left + ', top=' + top + ',screenX=' + left + ',screenY=' + top + '');
    }
    </script>
...
if($num>0)
{
$query=mysqli_query($con,"select products.productImage1 as pimg1,products.productName as pname,orders.productId as opid,orders.quantity as qty,products.productPrice as pprice,orders.orderDate as odate,orders.id as orderid from orders join products on orders.productId=products.id where orders.id='$orderid' and orders.orderStatus = 1");
$cnt=1;
                                        ...
                                        <tr>
                                            ...
                                            <td class="cart-image">
                                                <a class="entry-thumbnail" href="detail.html">
                                                    <img src="admin/productimages/<?= $row['opid'];?>/<?= $row['pimg1'];?>"
