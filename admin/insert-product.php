...
{?>
                               <script>
                                ...
                                <form class="form-horizontal row-fluid" name="insertproduct" method="post"
                                    enctype="multipart/form-data" onsubmit="return msg()">
...
{?>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="file" name="productimage1" id="productimage1" value=""
                                                class="span8 tip" required accept="image/*">
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="file" name="productimage2" class="span8 tip" required accept="image/*"> 
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="file" name="productimage3" class="span8 tip" accept="image/*">
                                        </div>
                                    </div>
